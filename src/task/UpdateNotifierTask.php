...
namespace DuoIncure\ComplexUpgradeUI\task;
...
class UpdateNotifierTask extends AsyncTask {
    ...
    public function onCompletion(): void {
        ...
        if ($highestVersion !== $this->pluginVersion) {
            ...
            $plugin->getLogger()->notice(vsprintf("%s %s has been released for API %s. Download the new release at %s", [$this->pluginName, $highestVersion, $api, $artifactUrl]));
        }
    }
}